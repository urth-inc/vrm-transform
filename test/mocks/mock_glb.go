...
func (mr *MockKtx2ConversionDependenciesInterfaceMockRecorder) CommandExecutor(name interface{}, args ...interface{}) *gomock.Call {
...
func (mr *MockKtx2ConversionDependenciesInterfaceMockRecorder) ContentTypeDetector(data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKtx2ConversionDependenciesInterfaceMockRecorder) FileCreator(filePath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKtx2ConversionDependenciesInterfaceMockRecorder) FileReader(filePath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKtx2ConversionDependenciesInterfaceMockRecorder) FileRemover(filePath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKtx2ConversionDependenciesInterfaceMockRecorder) ImageSizer(data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKtx2ConversionDependenciesInterfaceMockRecorder) ParamsGenerator(mode, width, height, inputPath, outputPath, isSRGB, etc1sQuality, uastcQuality, zstdLevel interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
